...
| Futures strategy R&D verdicts (2026-06-25) | [CTA swing momentum](archive/2026-06-25-futures-cta-swing-momentum.md) — **VALIDATED but NO-SHIP standalone**: edge is real but regime-concentrated and too weak alone; a regime-gated variant is a possible follow-up (PR #541). [Trend-day ORB](archive/2026-06-25-futures-trend-day-strategy.md) — **NO-SHIP**: walk-forward net-negative, OOS Sharpe −0.18, IS→OOS inversion = overfitting (PR #530). [Conviction-hold gate](archive/2026-06-25-futures-conviction-hold-strategy.md) — **NO-SHIP**: conjunction gate is anti-predictive, OOS 0% TP / −7.51% (PR #534). [mr-highvol Setup D spec](../specs/archive/2026-06-25-futures-mr-highvol-setup-d.md) — **SHIPPED to paper 2026-06-26** (PR #533), code live in main (`shared/decision/setups/vwap_reversion.py`, `shared/strategy/entry/setup_d_adapter.py`), `config/strategies/futures/setup_d_vwap_reversion.yaml` currently `enabled: true`. |
