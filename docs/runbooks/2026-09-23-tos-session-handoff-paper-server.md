...
| # | 항목 | 어디에 |
|---|---|---|
| 1 | ~~모의투자 프로브 7건~~ → **P-8 ×5 · P-EXT ×5 만 남음.** ~~앱키 연결 미반영~~ → **해소(2026-09-23 19:1x)**: 운영자가 `.env.mock` 을 새 계좌용 앱키·시크릿으로 교체, 새 주식·선물 계좌 모두 GET 조회 정상. **P-8 ×5 는 2026-09-28(월) 09:05 호스트 cron** — 1회차 게이트 유지. P-EXT MTS 동석 시각 미정. P-CA 2차(09-30)는 예전 계좌라 백업 자격증명으로 실행 | §4.2 · t3 README 「2026-09-23 19:1x」 |
