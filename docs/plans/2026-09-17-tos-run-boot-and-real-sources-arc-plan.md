...
기준선 main `7b76e217` 2292 tests → 최종 **2445**. 전 웨이브 **커널 diff 0**.
...
| **W2** (c2) 실 시세 | #727 | KIS 모의 시세 `ObservationIntake` · 토큰 수명주기 공유 추출 · `intake_kind` 명시 선택 · 팬텀 틱 방지 | 1차 HIGH 1 → 조치 → 재심 MEDIUM 1·LOW 1 → 조치 · `privacy-gate` 위반 0 |
