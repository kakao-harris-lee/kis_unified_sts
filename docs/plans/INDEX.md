...
| Plan | Status |
|---|---|
| [2026-07-04-runtime-refactoring-roadmap.md](2026-07-04-runtime-refactoring-roadmap.md) | **Runtime refactoring and event-driven roadmap** — additive Interface/Decorator/Factory plan to reduce coupling and agent context cost; covers setup-adapter split, registry/factory split, orchestrator decomposition, and safe futures monolith -> F-9 event-driven transition. |
