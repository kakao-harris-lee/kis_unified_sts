...
| digest | `expected_code_digest` 5차 재도출 `b96213f5…` → `2a7e483d…` → (B-1 회귀 수정 후) `90260205…`(`print-digests` = `observe_source_tree_digest()`) · `release.yaml` + `_VALUE_PINS` | 새 digest 로 Stage A 통과 부팅 확인 |
