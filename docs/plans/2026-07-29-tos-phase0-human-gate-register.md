...
| `MAX_time_conservative_freshness_age_ms` (UNCHK-024 잔여 1필드 — resolver `BarTimeProjection.max_age_bound`) | ADR-002-008 §9; 등록 2026-09-04, 같은 날 값 1000ms 승인(operator, Bounds-Approver) — `docs/plans/2026-09-04-tos-unchk024-max-age-bound-key-disposition-draft.md` §2, §6 |
