...
**운영자 처분 (2026-09-23): ①~④ 전부 추천안대로.** ① 런타임 Protocol 포트 도입 허용(별도 커밋 ·
리뷰 지점) · ② PR 5개 분할과 순서 채택 · ③ 불법 입력 표시는 `cast` · ④ 커널 결함은 보고 후 별도 PR.
3-a 는 이 처분 전에 착수했으나(①은 3-e 에만 걸린다) ③을 그대로 따랐다(`cast` 4 · `# type: ignore` 0).
