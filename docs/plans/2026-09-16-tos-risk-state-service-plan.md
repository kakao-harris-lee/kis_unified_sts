...
| a(관측) | **#703 → `6fa1750d`** | `29d50ec5`·`c4ffec2c` | `tos_runtime/riskstate/{policies(→shim 79), position 446, flow_observation 494}.py` + tests 66 · 리뷰 HIGH 1(`deployment_facts` 블록 부재 테스트) 처분 · 뮤테이션 11/11 red |
