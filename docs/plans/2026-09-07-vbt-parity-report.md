...
- 생성: 2026-09-07 16:18 KST, `scripts/vbt_parity_report.py`
...
- 러너: `shared/backtest/vbt_runner.py` — 전략별 `strategy.backtest.engine` 이 process-wide 기본값을 오버라이드. 기본값은 `config/backtest.yaml::backtest.default_engine` (2026-09-07 부로 `vectorbt`; 롤백은 env `BACKTEST_DEFAULT_ENGINE=legacy`) — 러너가 지원하지 않는 경로(선물·ATS·멀티심볼·공매도·regime gate·일봉 어댑터·허용목록 밖 exit)는 legacy 로 자동 폴백
...
| 자산곡선 / MDD | vectorbt cash·assets 시프트 재구성 — 부동소수 결합순서 ulp 잔차만 허용 (합성 `atol=1e-6` KRW / 실데이터 1e8 자본 스케일 `atol=1e-4` KRW; 이번 실행 관측치: 합성 ≤1.5e-08) |
...
| mean_reversion_exit × trend_up × default | 19 | ✅ exact | 0.00e+00 | 0.00e+00 | 0.00e+00 | 0.00e+00 | 0.00e+00 | ✅ | ✅ |
| mean_reversion_exit × trend_up × tight_sl_tp | 21 | ✅ exact | 0.00e+00 | 0.00e+00 | 1.86e-14 | 0.00e+00 | 1.86e-09 | ✅ | ✅ |
| mean_reversion_exit × trend_down × default | 54 | ✅ exact | 0.00e+00 | 0.00e+00 | 3.69e-14 | 0.00e+00 | 3.73e-09 | ✅ | ✅ |
| mean_reversion_exit × trend_down × tight_sl_tp | 110 | ✅ exact | 0.00e+00 | 0.00e+00 | 3.73e-14 | 0.00e+00 | 7.45e-09 | ✅ | ✅ |
| mean_reversion_exit × chop × default | 33 | ✅ exact | 0.00e+00 | 0.00e+00 | 1.82e-14 | 0.00e+00 | 5.59e-09 | ✅ | ✅ |
| mean_reversion_exit × chop × tight_sl_tp | 64 | ✅ exact | 0.00e+00 | 0.00e+00 | 3.77e-14 | 0.00e+00 | 1.12e-08 | ✅ | ✅ |
| momentum_decay × trend_up × default | 5 | ✅ exact | 0.00e+00 | 0.00e+00 | 0.00e+00 | 0.00e+00 | 0.00e+00 | ✅ | ✅ |
| momentum_decay × trend_up × tight_sl_tp | 17 | ✅ exact | 0.00e+00 | 0.00e+00 | 1.86e-14 | 0.00e+00 | 1.86e-09 | ✅ | ✅ |
| momentum_decay × trend_down × default | 20 | ✅ exact | 0.00e+00 | 0.00e+00 | 3.69e-14 | 0.00e+00 | 3.73e-09 | ✅ | ✅ |
| momentum_decay × trend_down × tight_sl_tp | 101 | ✅ exact | 0.00e+00 | 0.00e+00 | 0.00e+00 | 0.00e+00 | 7.45e-09 | ✅ | ✅ |
| momentum_decay × chop × default | 11 | ✅ exact | 0.00e+00 | 0.00e+00 | 3.71e-14 | 0.00e+00 | 1.86e-09 | ✅ | ✅ |
| momentum_decay × chop × tight_sl_tp | 64 | ✅ exact | 0.00e+00 | 0.00e+00 | 1.12e-13 | 0.00e+00 | 1.30e-08 | ✅ | ✅ |
...
- 경량 합성 전략: legacy 0.06s / vectorbt runner 0.19s → **vectorbt 가 3.49× 느림** (eval 당 vbt Portfolio 구성 고정 오버헤드 ~7ms)
...
운영자 flip(process-wide 기본값을 `config/backtest.yaml::backtest.default_engine: vectorbt` 로 전환, `docs/plans/2026-09-07-vectorbt-default-flip.md`) 은 본 리포트의 rc==0 을 필수 게이트로 요구한다 — 이 실행이 그 게이트다.
