...
- 구현: 2026-09-26 PR #806 — `docs/plans/2026-09-26-tos-periodic-time-eval-and-witness-wiring-plan.md` §7.2.
  §4.3 핀 3종 재현(뮤테이션 red 확인). 스케치와 다른 점 2가지(세션이 수명주기를 스스로 생성 · 어댑터 대체 경로로
  scope 사본 3)는 그 절에 적었다. 증인 배선은 여전히 범위 밖.
