...
작성 2026-09-08 · 세션 모델 단독 저작(운영자 지시 2026-09-04) · 기준 main `aa348ce1`(#654–#658 반영 후 재검증; 초안은 `a8e2d4f0`) · 상태 **승인 2026-09-09 · 구현 PR #660**(리뷰 4패스: 1차 확정 4·2차 확정 2 전건 CLOSED, 런타임 검증) · 결정 ①~④ = §9 권고안 채택 · 추가 결정: Setup D `no_entry_after_minutes_since_open` **345 유지**(PR #552 의 360 결정은 삭제된 `decision_engine.yaml` 에만 반영됐던 사실을 구현 중 발견 — 이력은 strategies YAML 주석에 기록)
