...
| Attempt | Setup | Trades | Win Rate | PF | Sharpe | MDD | Verdict |
|---------|-------|-------:|---------:|---:|-------:|----:|---------|
| 1 | MACD/EMA 15m default | 230 | 21.3% | 0.52 | -4.65 | 78.7% | ❌ |
| 2 | MACD/EMA 15m + 4h time_cut | 200 | 24.0% | 0.57 | -4.00 | 72.9% | ❌ |
| 3 | MACD/EMA 15m + volume_confirm + SL -3% | 61 | 24.6% | 0.48 | -4.13 | 22.6% | ❌ |
| 4 | MACD/EMA **60m** (key bug fix) | 65 | 32.3% | 0.81 | -1.28 | 26.3% | △ best manual |
| 5 | Optuna 120-trial sweep on (4), 25 trials run | — | — | — | -1.006 (best) | — | ❌ stopped |
| 6 | `trend_pullback` (stock port) | **0** | — | — | — | — | ❌ stock infra deps |
| 7 | `momentum_breakout` (stock port) | 36 | 13.9% | **0.01** | -11.0 | 47.9% | ❌ stock infra deps |
| 8 | `trix_golden` (stock port) | 68 | **41.2%** | 0.51 | -3.31 | 27.4% | ❌ EOD 87% |
...
PF < 1**. 4개 알고리즘 × 8가지 변형 모두 음수 Sharpe.
