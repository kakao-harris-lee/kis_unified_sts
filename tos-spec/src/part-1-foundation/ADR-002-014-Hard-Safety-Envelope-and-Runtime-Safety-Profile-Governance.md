...
9. Broker Capability Profile, Recovery Barrier Policy, Critical Input Policy, Safety Deviation Policy, canonical Active Deviation Set, Safety Incident Policy, canonical Active Safety Incident Set, Safety Monitoring Policy, Critical Telemetry Manifest, Monitor Coverage Manifest, Software Release Policy, exact Admitted Release Set, Release Generation, Release Artifact Manifest, runtime-attestation requirements, compatibility graph, source/mapping/lineage contract, and Failure-Domain Allocation consistency;
...
19. applicable activation, revocation, restriction-propagation, recovery-barrier, Critical Input, venue-constraint, aggregate-risk, action-flow, approval, currentness, and release invalidation, context/request/decision/permit/proof/vector/snapshot/provenance/admission/release-set/runtime-attestation/key-status age, readiness-age, time, evidence, and egress bounds are approved and measured;
