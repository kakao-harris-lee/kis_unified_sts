...
9. `B_egress_hard_fence` and all applicable currentness, revocation, HALT, failure-domain, session, and claim-to-send bounds are approved and measured;
10. no unresolved bypass or overlapping old/new egress authority remains;
