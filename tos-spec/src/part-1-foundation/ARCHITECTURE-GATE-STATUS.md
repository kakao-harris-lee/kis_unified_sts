...
29. VER-002-001 Safety-Critical Architecture Verification Evidence Specification
30. Evidence Register and configuration/evidence templates
...
| Verification Profile 1.8 | `PROPOSED`, `approved_by: []` | YES, as draft | NO |
...
| Verification evidence | 327 items registered, all `NOT_IMPLEMENTED` | NO claim of completion | NO |
...
2. Assign implementation owners, evidence owners, and independent reviewers for all 327 items in EVIDENCE-REGISTER-002.csv.
