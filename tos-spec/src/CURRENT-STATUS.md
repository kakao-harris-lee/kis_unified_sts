...
| Evidence | 490 total: 410 `NOT_IMPLEMENTED`, 79 `READY`, 1 `PASS` | Unit tests and document reviews do not move these rows; governed execution and review do. |
