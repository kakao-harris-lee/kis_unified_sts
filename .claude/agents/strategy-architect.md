...
- **REMOVED/DEPRECATED 회피**: `rl_mppo`(removed 2026-06-03), `llm_directed_indicator`(deprecated 2026-05-17)는 신규 설계에 사용 금지
...
- 청산 전략: `shared/strategy/exit/` (three_stage, atr_dynamic, chandelier_exit, momentum_decay, williams_r_exit, technical_consensus_exit, trix_golden_exit, builder_v1_exit 등)
