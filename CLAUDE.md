...
```bash
# 백테스트
sts backtest run --strategy bb_reversion --asset futures --start 2024-01-01 --end 2024-12-31

# 파라미터 최적화
sts optimize --strategy bb_reversion --asset futures --metric sharpe_ratio --trials 100
